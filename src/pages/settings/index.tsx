...
import { integrationsCards, organizationData, preferencesData, subscriptionCard, userDataSource } from '../../constants/Data';
    ...
    <>
      <div>
        <SettingsLayout handleSidebar={handleSidebar}>
          ...
          {settingComponent === 'users' && (
            <div className='table-responsive'><DynamicTable userDataSource={userDataSource} showModal={showModal} title={settingComponent}></DynamicTable></div>
          )}
          {settingComponent === 'organization' && (
            <div className='table-responsive'><DynamicTable organizationData={organizationData} showModal={showModal} title={settingComponent}></DynamicTable></div>
          )}
